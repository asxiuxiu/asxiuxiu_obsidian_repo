...
│   ├── AI/        # AI 相关
│   ├── C++/       # C++ 知识
│   ├── GameLearn/ # 游戏开发学习（从 Game/ 提炼的通用知识）
│   ├── graphics/  # 计算机图形学
│   └── Math/      # 数学
├── Plan/          # 📋 学习计划、方法论、路线图
...
| 文件夹 | 权限 | 说明 |
|--------|------|------|
| `Generated/` | ✅ AI 可读写 | AI 生成的知识笔记 |
| `Plan/` | ✅ AI 可读写 | 学习计划和方法论 |
| `Self/` | ❌ AI 禁止 | **除非用户明确要求，AI 不得读取、修改或创建此文件夹中的任何内容** |
| `Assets/` | ✅ AI 可读写 | 图片资源 |
...
- [[Plan/从零到入土的图形学学习.md]] — Why/What/How Good 结构
- [[Generated/C++/C++ 值类别与移动语义]] — 完整的 Why → What → How 流程
- [[Generated/Math/线性代数的本质/00-索引]] — 系列知识的层次组织
