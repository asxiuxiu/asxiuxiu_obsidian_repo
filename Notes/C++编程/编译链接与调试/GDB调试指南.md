...
> [!info] 前置知识
> - 了解 [[Notes/C++编程/C++编译选项.md|C++ 编译基础]] 有助于理解 GDB 的使用，特别是 `-g` 选项的作用
> - 深入理解调试器原理，参见 [[Notes/C++编程/编译链接与调试/调试器核心概念与原理|调试器核心概念与原理]]
...
- [[Notes/C++编程/编译链接与调试/调试器核心概念与原理|调试器核心概念与原理]] - 深入理解 Symbol、DWARF、断点原理等核心概念
- [[Notes/C++编程/C++编译选项.md|C++ 编译选项详解]]
