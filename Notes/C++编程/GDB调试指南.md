...
> [!info] 前置知识
> - 了解 [[C++编程/C++编译选项.md|C++ 编译基础]] 有助于理解 GDB 的使用，特别是 `-g` 选项的作用
> - 深入理解调试器原理，参见 [[C++编程/调试器核心概念与原理.md|调试器核心概念与原理]]
...
- [[C++编程/调试器核心概念与原理.md|调试器核心概念与原理]] - 深入理解 Symbol、DWARF、断点原理等核心概念
- [[C++编程/C++编译选项.md|C++ 编译选项详解]]
- [[C++编程/C++编译过程原理.md|C++ 编译过程原理]]
